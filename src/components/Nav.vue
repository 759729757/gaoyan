    ...
    <div class="banner-top ">
      <div class="container nav-warp">
        <div class="logo-warp pull-left">
          <img class="_logo" src="../assets/logo.svg">
          <img class="_logo-name" src="../assets/logoName.svg" >
        </div>
      </div>
...
<style scoped>
  ...
  .rolled .nav-menu li a:hover,.rolled .nav-menu li.active a{color: #00548f;}
